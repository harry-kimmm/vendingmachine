...
public class VendingMachineFrame extends JFrame implements ActionListener{
    ...
    JButton buyButton, addButton, addFieldBut, addBut2, buyFieldBut, addFieldBut2;
    JLabel buy, add;
    boolean keypressable = false;
    VendingMachine machine;
    Item ichezit, idoritos, igatorade, ireeses, isprite, iwater;
    Customer customer;
    JLabel balLabel, chezitnum, doritosnum, gatoradenum, reesesnum, spritenum, waternum;
    JLabel chezit, doritos, gatorade, reeses, sprite, water;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==buyFieldBut) {
            if(buyField.getText().equals("1") && ichezit.getAmount() > 0 && customer.getBalance() > Double.parseDouble(ichezit.getprice())){
                ...
                chezitnum.setText(ichezit.getAmount() + " | $" + ichezit.getprice());
                if(ichezit.getAmount() == 0){
                    chezit.setVisible(false);
                }
            }
            if(buyField.getText().equals("2")  && idoritos.getAmount() > 0 && customer.getBalance() > Double.parseDouble(idoritos.getprice())){
                customer.setBalance(customer.getBalance() - 2.50);
                balLabel.setText("Balance: $" + Math.round(customer.getBalance() * 100.0) / 100.0);
                buyField.setVisible(false);
                buyFieldBut.setVisible(false);
                ...
                doritosnum.setText(idoritos.getAmount() + " | $" + idoritos.getprice());
                if(idoritos.getAmount() == 0){
                    doritos.setVisible(false);
                }
            }
            if(buyField.getText().equals("3") && igatorade.getAmount() > 0 && customer.getBalance() > Double.parseDouble(igatorade.getprice())){
                ...
                gatoradenum.setText(igatorade.getAmount() + " | $" + igatorade.getprice());
                if(igatorade.getAmount() == 0){
                    gatorade.setVisible(false);
                }
            }
            if(buyField.getText().equals("4") && ireeses.getAmount() > 0 && customer.getBalance() > Double.parseDouble(ireeses.getprice())){
                ...
                reesesnum.setText(ireeses.getAmount() + " | $" + ireeses.getprice());
                if(ireeses.getAmount() == 0){
                    reeses.setVisible(false);
                }
            }
            if(buyField.getText().equals("5" ) && isprite.getAmount() > 0 && customer.getBalance() > Double.parseDouble(isprite.getprice())){
                customer.setBalance(customer.getBalance() - 1.50);
                balLabel.setText("Balance: $" + Math.round(customer.getBalance() * 100.0) / 100.0);
                buyField.setVisible(false);
                buyFieldBut.setVisible(false);
                ...
                spritenum.setText(isprite.getAmount() + " | $" + isprite.getprice());
                if(isprite.getAmount() == 0){
                    sprite.setVisible(false);
                }
            }
            if(buyField.getText().equals("6") && iwater.getAmount() > 0 && customer.getBalance() > Double.parseDouble(iwater.getprice())){
                customer.setBalance(customer.getBalance() - 1.00);
                balLabel.setText("Balance: $" + Math.round(customer.getBalance() * 100.0) / 100.0);
                buyField.setVisible(false);
                buyFieldBut.setVisible(false);
